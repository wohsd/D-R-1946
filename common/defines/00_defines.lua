...
NResistance = {
	...
	COMPLIANCE_FACTOR_ON_Police_policy5LER_CHANGE = -0.5,	-- compliance factor that applies when the state controller changes (in between allies, compliance is zeroed if it is taken by original country)
...
NAI = {
	...
	GIVE_Police_policy5_MIN_CONTROLLED = 1,		-- AI needs to control more than this number of states before considering giving any away
	GIVE_Police_policy5_MIN_CONTROL_DIFF = 2,	-- The difference in number of controlled states compared to war participation needs to be bigger than this for the AI to consider giving a state to a country
	...
	GIVE_Police_policy5_BASE_SCORE = 50,			-- Base diplo score for giving away control of states
	GIVE_Police_policy5_DIFF_FACTOR = 2.0,		-- Diplo score multiplier for state control compared to war participation difference
	GIVE_Police_policy5_NEIGHBOR_SCORE = 20,		-- Diplo score for each neighboring state controlled by the target
	GIVE_Police_policy5_NEIGHBOR_ACTOR_SCORE = -5, -- Diplo score for each neighboring state that is controlled by the sender
	GIVE_Police_policy5_NEIGHBOR_OTHER_SCORE = 5, -- Diplo score for each neighboring state controlled by someone else
	GIVE_Police_policy5_MAX_SCORE_DIST = 600,	-- A State that is closer to the recipient capital than this gets a score bonus based on the below value
	GIVE_Police_policy5_DIST_SCORE_MULT = 0.2,	-- Multiplier for the score gained from distance ( GIVE_Police_policy5_MAX_SCORE_DIST - distance ) * this
	...
	Police_policy5_FOR_AREA_DEFENSE = 0.4,				-- To avoid AI sending area defense to area with very little foothold
